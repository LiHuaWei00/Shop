...
<!--start-logo-->
<div class="logo">
    <a href="index_m.jsp"><h1>Luxury Watches</h1></a>
</div>
<!--start-logo-->
<!--bottom-header-->
            ...
            <div class="product-one">
                ...
                <div class="col-md-3 product-left">
                    <div class="product-main simpleCart_shelfItem">
                        <a href="WatchDatileServlet?id=${watch.id}"  class="mask"><img class="img-responsive zoom-img" src="images/${watch.watch_url}" alt="" /></a>
                        <div class="product-bottom">
                            <h3>${watch.watch_type.name}</h3>
                            <p>立即搜索</p>
                            <h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">$ ${watch.watch_price}</span></h4>
                        </div>
                        <div class="srch">
                            <span>-50%</span>
                        </div>
